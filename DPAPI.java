...
class DPAPI {
    ...
    /**
     * 
     * @param input Binary data to encrypt
     * @param entropy Additional entropy to include when encrypting (optional)
     * @return 
     */
    static native byte[] CryptUnprotectDataBinary(byte[] input, byte[] entropy);
    
    /**
     * 
     * @param intpu Cipherdata
     * @param entropy If true, allow all users on the machine to decrypt the return ciphertext
     * @param localMachine
     * @return cipherdata
     */
    static native byte[] CryptProtectDataBinary(byte[] intpu, byte[] entropy, boolean localMachine);
