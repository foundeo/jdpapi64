...
public class DataProtector {
     ...
     * @return cipherdata
     */
    public byte[] protectData(byte[] input) {
        return DPAPI.CryptProtectDataBinary(input, entropy, localMachine);
    }
    
    /**
     * 
     * @param input Cipherdata
     * @return binary data
     */
    public byte[] unprotectData(byte[] input) {
        return DPAPI.CryptUnprotectDataBinary(input, entropy);
    }
}
